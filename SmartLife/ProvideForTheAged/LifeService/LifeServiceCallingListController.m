...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([statusString isEqualToString:@"我要接单"]){
        ...
        LifeServiceAcceptOrderSuccessController *lifeServiceAcceptOrderSuccessVC = [[LifeServiceAcceptOrderSuccessController alloc] initWithServiceRecord:dataItem];
...
- (void)doAcceptOrder:(id)sender{
    ...
    LifeServiceAcceptOrderController *lifeServiceAcceptOrderVC = [[LifeServiceAcceptOrderController alloc] initWithServiceRecord:dataItem];
