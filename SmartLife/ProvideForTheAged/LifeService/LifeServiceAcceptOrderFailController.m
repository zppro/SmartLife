//
//  LifeServiceAcceptOrderFailController.m
//  SmartLife
//
...
@interface LifeServiceAcceptOrderFailController ()

@end

@implementation LifeServiceAcceptOrderFailController
...
- (void)viewDidLoad
{
    ...
    self.headerView.headerLabel.text = @"生活服务－接单失败";
